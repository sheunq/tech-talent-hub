...
const mockOpportunities: Opportunity[] = [
  {
    ...
    tags: ['Web Development', 'React', 'Next.js', 'Paid'],
    icon: <BookOpen className="h-7 w-7 text-primary" />,
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'laptop code screen',
  ...
  },
  {
    ...
    tags: ['Scholarship', 'AI/ML', 'University', 'Financial Aid'],
    icon: <Award className="h-7 w-7 text-primary" />,
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'graduation cap certificate',
  ...
  },
  {
    ...
    tags: ['Cybersecurity', 'Intensive', 'Career Change', 'Certification'],
  ...
  },
  {
    ...
    tags: ['Conference', 'DevOps', 'Cloud', 'Networking'],
    icon: <CalendarDays className="h-7 w-7 text-primary" />,
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'conference presentation stage',
  ...
  },
   {
    ...
    tags: ['Cloud Computing', 'AWS', 'Beginner', 'Free'],
    icon: <BookOpen className="h-7 w-7 text-primary" />,
    imageUrl: 'https://placehold.co/600x400.png',
    imageHint: 'cloud servers network',
  ...
  },
   {
    ...
    tags: ['Open Source', 'Development', 'Guide', 'Free'],
