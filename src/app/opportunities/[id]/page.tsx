...
const mockOpportunities: Opportunity[] = [
  ...
  },
  {
    ...
    description: 'Supporting outstanding students pursuing research and careers in Artificial Intelligence and Machine Learning.',
  ...
  },
  {
    id: 'event1',
    type: 'Event',
    title: 'DevOps Global Summit 2025',
    provider: 'CloudNative Events',
    description: 'The premier event for DevOps professionals, featuring workshops, keynotes, and networking opportunities.',
    fullDescription: 'Join thousands of DevOps practitioners, SREs, and cloud engineers at the DevOps Global Summit 2025. This three-day event features expert-led workshops, inspiring keynotes from industry leaders, technical deep-dives, and unparalleled networking opportunities. Explore the latest trends in CI/CD, Kubernetes, serverless, observability, and cloud security.',
    tags: ['Conference', 'DevOps', 'Cloud', 'Networking', 'Kubernetes'],
    icon: <CalendarDays className="h-7 w-7 text-primary" />,
    imageUrl: 'https://placehold.co/800x450.png',
    imageHint: 'conference stage audience',
    learnMoreUrl: 'https://example.com/devops-summit',
    duration: '3 Days',
    format: 'Hybrid',
    applicationDeadline: '2025-07-01 (Early Bird)',
  ...
  },
   {
    ...
    description: 'Learn the fundamentals of cloud computing and get hands-on experience with AWS services.',
