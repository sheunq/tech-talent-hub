...
const allMockTalentProfiles: TalentProfile[] = [
  { id: 'talent1', fullName: 'Alice Wonderland', headline: 'Senior Frontend Developer | React Expert', skills: ['React', 'TypeScript', 'Next.js', 'GraphQL', 'Node.js', 'UI/UX Design'], experienceYears: 7, availability: 'Open to opportunities', location: 'Remote (USA)', profilePictureUrl: '/images/vision.jpg', summary: 'Passionate frontend developer with 7 years of experience building scalable and user-friendly web applications. Proven ability to lead projects and mentor junior developers. Always eager to learn new technologies.' },
  { id: 'talent2', fullName: 'Bob The Builder', headline: 'Full-Stack Engineer | Python & Django Specialist', skills: ['Python', 'Django', 'Flask', 'JavaScript', 'Docker', 'AWS', 'PostgreSQL'], experienceYears: 5, availability: 'Available immediately', location: 'New York, NY', profilePictureUrl: '/images/vision.jpg', summary: 'Results-oriented full-stack engineer with a strong background in Python and cloud technologies. Adept at developing robust backend systems and collaborating in agile environments.' },
  { id: 'talent3', fullName: 'Carol Danvers', headline: 'Cloud & DevOps Engineer | AWS Certified', skills: ['AWS', 'Kubernetes', 'Terraform', 'CI/CD', 'Jenkins', 'Linux', 'Python'], experienceYears: 8, availability: 'Not actively looking', location: 'San Francisco, CA', profilePictureUrl: '/images/vision.jpg', summary: 'Experienced DevOps engineer focused on automating infrastructure and streamlining deployment pipelines on AWS. Strong problem-solving skills and a passion for cloud-native solutions.' },
  { id: 'talent4', fullName: 'David Copperfield', headline: 'UX/UI Designer | Mobile & Web Applications', skills: ['Figma', 'Sketch', 'Adobe XD', 'User Research', 'Prototyping', 'Interaction Design', 'HTML', 'CSS'], experienceYears: 4, availability: 'Open to opportunities', location: 'Remote (Europe)', profilePictureUrl: '/images/vision.jpg', summary: 'Creative UX/UI designer with a knack for crafting intuitive and visually appealing digital experiences. Proficient in all stages of the design process, from concept to high-fidelity prototypes.' },
  { id: 'talent5', fullName: 'Eve Moneypenny', headline: 'Data Scientist | Machine Learning Enthusiast', skills: ['Python', 'R', 'SQL', 'TensorFlow', 'PyTorch', 'Scikit-learn', 'Data Visualization', 'Statistics'], experienceYears: 6, availability: 'Available immediately', location: 'Austin, TX (Hybrid)', profilePictureUrl: '/images/vision.jpg', summary: 'Data scientist with 6 years of experience in developing machine learning models and deriving actionable insights from complex datasets. Strong analytical and communication skills.' },
];
